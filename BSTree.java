...
public class BSTree{
    ...
    public static void main(String[] args){
        ...
        String usage="Usage: java BSTree part('part1a' or 'part2') function('build' or 'test') data/tree-file key-file.\n\n"+
            "Example:\n1. java BSTree part1a build bst_test_data.txt test_key.txt\n"+
            "2. java BSTree part1a test 1a_clean.txt test_key.txt\n"+
            "3. java BSTree part2 build bst_test_data.txt test_key.txt\n"+
            "4. java BSTree part2 test 2_clean.txt test_key.txt\n";
        ...
        boolean part2=false,test=false,error=false;
        if(args[0].equals("part1a")){
            part2=false;
        ...
        String datafile=args[2],keyfile=args[3];
        
        if(!part2){
            if(!test){
                BSTree bst=new BSTree(false, datafile, keyfile);
                System.out.print(bst.getBFSTree());
            }else{
                BSTree bst=new BSTree(datafile, keyfile, false);
                System.out.println(bst.getResult(false));
            }
        }else{
            if(!test){
                BSTree bst1=new BSTree(true, datafile, keyfile);
                System.out.print(bst1.getBFSTree());
            }else{
                BSTree bst=new BSTree(datafile, keyfile, true);
