...
public class integrityVerifier extends JFrame implements ActionListener{
    ...
    public void changeToHelp(){
        ...
        _rightTextarea.setText("Help:\n1. To test a part, click on the corresponding button above.\n"+
              "2. After typing in file names, click on 'construct' or 'verify' button.\n"+
                               "3. If you still need help, email us at lirongyuan1000@gmail.com.\n\n");
        setInputable(false);
    }
