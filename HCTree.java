...
public class HCTree{
    ...
    public static void main(String[] args){
        ...
        String usage="Usage: java BSTree function('build' or 'test') tree-file key-file.\n\n"+
            "Example:\n1. java HCTree build HCT/huff_test_mssg.txt HCT/test_key.txt\n"+
            "2. java HCTree test HCT/1b_dirty.txt HCT/test_key.txt\n";
        ...
        boolean test=false,error=false;
        ...
        String datafile=args[1],keyfile=args[2];
        
        
        if(!test){
            HCTree hct=new HCTree(datafile,keyfile);
            System.out.println(hct.getBFSTree());
        }else{
            HCTree hct=new HCTree(datafile,keyfile,true);
        ...
        System.out.println(hct.getResult());*/
        /*HCTree hct=new HCTree("HCT/huff_test_mssg.txt","HCT/test_key.txt",true);
        System.out.println(hct.getResult());*/
    }
